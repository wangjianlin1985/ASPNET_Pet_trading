 ...
 <form id="form1" runat="server">
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="frontList.aspx">宠物出售信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="frontAdd.aspx" style="display:none;">添加宠物出售</a>
		</ul>
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%#(((Container.ItemIndex+0)%4==0)?"style='clear:left;'":"") %>>
			  <a href="frontshow.aspx?sellId=<%#Eval("sellId")%>"><img class="img-responsive" src="../<%#Eval("productPhoto")%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		宠物名称: <%#Eval("productName")%>
			     	</div>
			     	<div class="field">
	            		宠物分类:<%#GetProductClassproductClassObj(Eval("productClassObj").ToString())%>
			     	</div>
			     	<div class="field">
	            		出售价格: <%#Eval("sellPrice")%>
			     	</div>
			     	<div class="field">
	            		宠物年龄段:<%#GetXjcdxjcdObj(Eval("xjcdObj").ToString())%>
			     	</div>
			     	<div class="field">
	            		出售说明: <%#Eval("sellDesc")%>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				<label for="productName">宠物名称:</label>
				<asp:TextBox ID="productName" runat="server"  CssClass="form-control" placeholder="请输入宠物名称"></asp:TextBox>
			</div>
            <div class="form-group">
            	<label for="productClassObj_productClassId">宠物分类：</label>
                <asp:DropDownList ID="productClassObj" runat="server"  CssClass="form-control" placeholder="请选择宠物分类"></asp:DropDownList>
            </div>
            <div class="form-group">
            	<label for="xjcdObj_xjcdId">宠物年龄段：</label>
                <asp:DropDownList ID="xjcdObj" runat="server"  CssClass="form-control" placeholder="请选择宠物年龄段"></asp:DropDownList>
            </div>
            <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;宠物出售信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="productSell_productName_edit" class="col-md-3 text-right">宠物名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="productSell_productName_edit" name="productSell.productName" class="form-control" placeholder="请输入宠物名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="productSell_productClassObj_productClassId_edit" class="col-md-3 text-right">宠物分类:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="productSell_productPhoto_edit" class="col-md-3 text-right">宠物主图:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="productSell_xjcdObj_xjcdId_edit" class="col-md-3 text-right">宠物年龄段:</label>
		  	 <div class="col-md-9">
