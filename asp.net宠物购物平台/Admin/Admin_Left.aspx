...
<body>
    ...
    <img src="Images/MenuTop.jpg"/><br /><img src="images/menu_topline.gif" alt=""/>
        ...
        <div class="Menu"><img src="Images/News.gif" alt=""/>&nbsp;宠物分类管理</div>
        <div class="MenuNote" style="display:none;" id="ProductClassDiv" runat="server">
            <img src="images/menu_topline.gif" alt="" />
            <ul class="MenuUL">
                <li><a href="ProductClassEdit.aspx" target="main">添加宠物分类</a></li>
                <li><a href="ProductClassList.aspx" target="main">宠物分类查询</a></li> 
            </ul>
        </div>

        <div class="Menu"><img src="Images/News.gif" alt=""/>&nbsp;宠物求购管理</div>
        <div class="MenuNote" style="display:none;" id="ProductSeekDiv" runat="server">
            <img src="images/menu_topline.gif" alt="" />
            <ul class="MenuUL">
                <li><a href="ProductSeekEdit.aspx" target="main">添加宠物求购</a></li>
                <li><a href="ProductSeekList.aspx" target="main">宠物求购查询</a></li> 
            </ul>
        </div>

        <div class="Menu"><img src="Images/News.gif" alt=""/>&nbsp;宠物出售管理</div>
        <div class="MenuNote" style="display:none;" id="ProductSellDiv" runat="server">
            <img src="images/menu_topline.gif" alt="" />
            <ul class="MenuUL">
                <li><a href="ProductSellEdit.aspx" target="main">添加宠物出售</a></li>
                <li><a href="ProductSellList.aspx" target="main">宠物出售查询</a></li> 
            </ul>
        </div>

        <div class="Menu"><img src="Images/News.gif" alt=""/>&nbsp;宠物订单管理</div>
        <div class="MenuNote" style="display:none;" id="ProductOrderDiv" runat="server">
            <img src="images/menu_topline.gif" alt="" />
            <ul class="MenuUL">
                <li><a href="ProductOrderEdit.aspx" target="main">添加宠物订单</a></li>
                <li><a href="ProductOrderList.aspx" target="main">宠物订单查询</a></li> 
            </ul>
        </div>
 ...
 <!--
        ...
        <div class="MenuNote" style="display:none;" id="Div2" runat="server">
         ...
         <div class="Menu"><img src="Images/News.gif" alt=""/>&nbsp;宠物年龄段管理</div>
        <div class="MenuNote" style="display:none;" id="XjcdDiv" runat="server">
            <img src="images/menu_topline.gif" alt="" />
            <ul class="MenuUL">
                <li><a href="XjcdEdit.aspx" target="main">添加宠物年龄段</a></li>
                <li><a href="XjcdList.aspx" target="main">宠物年龄段查询</a></li> 
            </ul>
        </div>
