   ...
   <link href="Style/Manage.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        function CheckIn() {
            ...
            if (productClassName == "") {
                alert("请输入类别名称...");
                document.getElementById("productClassName").focus();
                return false;
            }
...
<body>
    <form id="form1" runat="server">
        <div class="div_All">
    <div class="Body_Title">宠物分类管理 》》编辑宠物分类</div>
        <hr />
        <table cellspacing="1" cellpadding="2">
                 <tr>
                   ...
                   类别名称：</td>
                    <td width="650px;">
                         <input id="productClassName" type="text"   style="width:200px;" runat="server" maxlength="25"/><span class="WarnMes">*</span>请输入类别名称！</td>
                </tr>
