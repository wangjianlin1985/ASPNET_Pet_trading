<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frontUserAdd.aspx.cs" Inherits="Leaveword_frontAdd" %>
...
<uc:header ID="header" runat="server" />
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Leaveword/frontList.aspx">留言管理</a></li>
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group" style="display:none;">
				  	 ...
				  	 <div class="col-md-8">
		                <div id="leaveword_replyTimeDiv" class="input-group date leaveword_replyTime col-md-12" data-link-field="leaveword_replyTime">
		                    <input class="form-control" id="leaveword_replyTime" name="leaveword.replyTime" size="16" type="text" value="9999-1-1" placeholder="请选择回复时间" readonly>
		                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
		                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		                </div>
				  	 </div>
		          ...
		          <style>#leavewordAddForm .form-group {margin:5px;}  </style>  
				</form> 
			</div>
...
var basePath = "<%=basePath%>";
	...
	function ajaxLeavewordAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "Leaveword/LeavewordController.aspx?action=userAdd",
			dataType : "json" , 
