...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">宠物交易网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>ProductOrder/frontlist.aspx">宠物订单</a></li>
                <li><a href="<%=basePath %>Xjcd/frontlist.aspx">宠物年龄段</a></li>
                -->
                <li><a href="<%=basePath %>ProductClass/frontlist.aspx">宠物分类</a></li>
                <li><a href="<%=basePath %>ProductSeek/frontlist.aspx">宠物求购</a></li>
                <li><a href="<%=basePath %>ProductSell/frontlist.aspx">宠物出售</a></li> 
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel"> 
                        ...
                        <li><a href="<%=basePath %>ProductSeek/frontUserAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布宠物求购</a></li>
                        ...
                        <li><a href="<%=basePath %>ProductSell/frontUserAdd.aspx"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;发布出售宠物</a></li>
