 ...
 <form id="form1" runat="server">
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="frontList.aspx">宠物求购信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="frontAdd.aspx" style="display:none;">添加宠物求购</a>
		</ul>
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%#(((Container.ItemIndex+0)%4==0)?"style='clear:left;'":"") %>>
			  <a href="frontshow.aspx?seekId=<%#Eval("seekId")%>"><img class="img-responsive" src="../<%#Eval("productPhoto")%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		宠物类别:<%#GetProductClassproductClassObj(Eval("productClassObj").ToString())%>
			     	</div>
			     	<div class="field">
	            		求购价格: <%#Eval("price")%>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
            ...
            <div class="form-group">
            	<label for="productClassObj_productClassId">宠物类别：</label>
                <asp:DropDownList ID="productClassObj" runat="server"  CssClass="form-control" placeholder="请选择宠物类别"></asp:DropDownList>
            </div>
            <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;宠物求购信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="productSeek_productName_edit" class="col-md-3 text-right">宠物名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="productSeek_productName_edit" name="productSeek.productName" class="form-control" placeholder="请输入宠物名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="productSeek_productClassObj_productClassId_edit" class="col-md-3 text-right">宠物类别:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="productSeek_productPhoto_edit" class="col-md-3 text-right">宠物主图:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="productSeek_xjcdObj_xjcdId_edit" class="col-md-3 text-right">宠物年龄段:</label>
		  	 <div class="col-md-9">
