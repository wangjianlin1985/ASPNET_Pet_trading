...
namespace DAL
{
    ...
    public class dalProductSell
    {
        ...
        public static bool AddProductSell(ENTITY.ProductSell productSell)
        {
            ...
            /*给参数赋值*/
            parm[0].Value = productSell.productName; //宠物名称
            parm[1].Value = productSell.productClassObj; //宠物分类
            parm[2].Value = productSell.productPhoto; //宠物主图
            parm[3].Value = productSell.sellPrice; //出售价格
            parm[4].Value = productSell.xjcdObj; //宠物年龄段
