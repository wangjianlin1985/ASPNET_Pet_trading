...
namespace DAL
{
    ...
    public class dalProductSeek
    {
        ...
        public static bool AddProductSeek(ENTITY.ProductSeek productSeek)
        {
            ...
            /*给参数赋值*/
            parm[0].Value = productSeek.productName; //宠物名称
            parm[1].Value = productSeek.productClassObj; //宠物类别
            parm[2].Value = productSeek.productPhoto; //宠物主图
            parm[3].Value = productSeek.price; //求购价格
            parm[4].Value = productSeek.xjcdObj; //宠物年龄段
